...
const skillsSection = {
  ...
  skills: [
    ...
    emoji(
      "⚡  I care about the details — accessibility, performance and user experience."
    ),
    emoji(
      "⚡  I’ve worked on platforms and CMS-based websites, integrating APIs and third-party tools."
    ),
    emoji("⚡  I’m a quick learner who adapts fast and eager to grow.")
  ],
